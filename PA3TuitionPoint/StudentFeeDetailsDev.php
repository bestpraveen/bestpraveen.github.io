...
window.location.href = 'StudentFeeDetails.php' + '?SearchAdvance=Yes' + '&searchName=' + searchName + '&Class=' + Class + '&StartDate=' + StartDate;
      }
...
<td>
        ...
        margin: 1rem;
        font-size: 1.6rem;
        margin-bottom: 2rem;"><?php echo "Start Date: " . date('d M Y', strtotime($StartDate)) ;?> </label> 
