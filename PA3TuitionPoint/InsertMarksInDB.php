...
//INSERT INTO `StResult` (`SN`, `Result_Id`, `ID`, `Class`, `ExamDate`, `Subject`, `Level`, `TotMarks`, `MarksObtained`, `Percentage`) VALUES (NULL, '', '', '7', '2021-08-19', 'Math', '', '1000', '10000', '100000.00');
    ...
    $sql3 = "INSERT INTO `StResult` (`Result_Id`, `ID`, `Class`, `ExamDate`, `Subject`, `Level`, `TotMarks`, `MarksObtained`, `Percentage`) VALUES ('$Result_Id', '$ID', '$Class', '$ExamDate', '$Subject', '$Level', '$TotMarks', '$MarksObtained', '$Percentage')";
