...
<head>
	...
	function SearchAdvance(searchClass, searchSubject)
	  {		
		window.location.href ='DipsMarks_IITLevel.php' + '?SearchAdvance=Yes' + '&searchClass=' + searchClass + '&searchSubject=' + searchSubject;
      }
...
<div class="container">
    <table border="1" width="90%" align="Center">
        ...
        <form action="DipsMarks_IITLevel.php" method="get" id="formControler" style="text-align: center;
        font-size: 30px;">
...
<?php
		...
		$sql1 = "SELECT DISTINCT(ID) FROM StResult_IITLevel";
//$searchClass $searchSubject
		...
		$sql1= str_replace("StResult_IITLevel AND Subject", "StResult_IITLevel WHERE Subject", $sql1);
...
//$searchClass $searchSubject
        if ($result1->num_rows >= 0) 
		{
            while ($row = $result1->fetch_assoc()) 
			{
                ...
                $sqlAVG    = "SELECT Avg(Percentage) FROM StResult_IITLevel WHERE ID='$ID'";
				...
				$sqlAVGMath    = "SELECT Avg(Percentage) FROM StResult_IITLevel WHERE ID='$ID' AND Subject='Math'";
				...
				$sqlAVGScience    = "SELECT Avg(Percentage) FROM StResult_IITLevel WHERE ID='$ID' AND Subject='Science'";
    ...
    font-weight: 500;'><a style='color:$valueCol;' target=\"_Blank\" href=\"DipsMarksDetails_IITLevel.php?SearchAdvance=Yes&searchClass=15&searchSubject=$Subject&searchExamTitle=All&searchName=$keyID\">$value %</a></td>";
	...
	if ($searchSubject=="All")
	{
		...
		font-weight: 500;'><a style='color:$valueMathCol;'  target=\"_Blank\" href=\"DipsMarksDetails_IITLevel.php?SearchAdvance=Yes&searchClass=15&searchSubject=Math&searchExamTitle=All&searchName=$keyID\">$valueMath</a></td> ";

		echo " <td title='Click for Details' style='font-size: 1.6rem;  text-align: center;font-family: `Ubuntu`, sans-serif;
		font-weight: 500;'><a style='color:$valueScienceCol;'  target=\"_Blank\" href=\"DipsMarksDetails_IITLevel.php?SearchAdvance=Yes&searchClass=15&searchSubject=Science&searchExamTitle=All&searchName=$keyID\">$valueScience</a></td> ";
	}


	echo "  <td><a target=\"_Blank\" href=\"DipsMarksDetails_IITLevel.php?SearchAdvance=Yes&searchClass=15&searchSubject=$Subject&searchExamTitle=All&searchName=$keyID\">Click 4 Details </a></td>";
                echo "</tr>";
			}
