<?php session_start();
if(empty($_SESSION['username'])){header("Location:loginAdmin.php?type=addmarks"); exit;}
$u=$_SESSION['username'];
//echo "user= $u";
?>
<html>
   ...
   $searchTotMarks = $_GET['TotMarks'];
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
			...
			$sql333    = "SELECT TotMarks, MarksObtained, Percentage FROM StResult where Result_Id='$Result_Id'";
