...
//$sql3 = "INSERT INTO StFees (`Fee_Id`, `ID`, `Class`, `Date`, `FeesPaid`, `FeeMonth`, `Summary`) VALUES ('$Fee_Id', '$ID', '$Class', '$Date', '$FeesPaid', '$FeeMonth', '$Summary');";
				...
				echo "<form  target=\"_blank\" action=\"InsertFeeInDB.php\" method=\"get\" id=\"formControler\" style=\"text-align: center;
        font-size: 15px;\">";
				echo "<tr>";
				echo "<td>$sn</td>";
				echo "<td>$Fee_Id </td>";
		...
		echo "<tr><td></td><td></td><td></td><td></td><td></td><td><b>Total</b></td><td><b>$MonthlyFeesTot</b></td><td><b>$FeesPaidTot</b></td><td><b>Balance=$Bal</b></td><td></td></tr>";
