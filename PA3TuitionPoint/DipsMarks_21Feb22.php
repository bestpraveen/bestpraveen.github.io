...
//$searchClass $searchSubject
		...
		$sql1= str_replace("StResult AND Subject", "StResult WHERE Subject", $sql1);
...
//$searchClass $searchSubject
        if ($result1->num_rows >= 0) 
		{
            while ($row = $result1->fetch_assoc()) 
			{
                ...
                $sqlAVG    = "SELECT Avg(Percentage) FROM StResult WHERE ID='$ID'";
    ...
    font-weight: 500;'><a style='color:$valueCol;' target=\"_Blank\" href=\"DipsMarksDetails.php?SearchAdvance=Yes&searchClass=15&searchSubject=$Subject&searchExamTitle=All&searchName=$keyID\">$value %</a></td>";
	...
	if ($searchSubject=="All")
	{
		...
		font-weight: 500;'><a style='color:$valueMathCol;'  target=\"_Blank\" href=\"DipsMarksDetails.php?SearchAdvance=Yes&searchClass=15&searchSubject=Math&searchExamTitle=All&searchName=$keyID\">$valueMath</a></td> ";

		echo " <td title='Click for Details' style='font-size: 1.6rem;  text-align: center;font-family: `Ubuntu`, sans-serif;
		font-weight: 500;'><a style='color:$valueScienceCol;'  target=\"_Blank\" href=\"DipsMarksDetails.php?SearchAdvance=Yes&searchClass=15&searchSubject=Science&searchExamTitle=All&searchName=$keyID\">$valueScience</a></td> ";
	}
